...
@class ClassroomPlayBottomView;
@protocol ClassroomPlayBottomViewDelegate <NSObject>
...
@interface ClassroomPlayBottomView : UIView

@property (nonatomic, weak) id<ClassroomPlayBottomViewDelegate>delegate;
