...
@implementation FWMCommentFCell

#pragma mark - Life Cycle

static NSString * const kCellID = @"FWMCommentFCell";

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    FWMCommentFCell *cell = [tableView dequeueReusableCellWithIdentifier:kCellID];
    if (!cell) {
        cell = [[FWMCommentFCell alloc] initWithStyle:0 reuseIdentifier:kCellID];
    }
    return cell;
}
