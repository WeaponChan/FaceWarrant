...
- (void)titleViewWithTitleViewAddClick:(LSPTitleView *)titleView selectedIndex:(NSInteger)selectedIndex
{
    if ([self.delegate respondsToSelector:@selector(pageViewAddClick:WithIndex:)]) {
        [self.delegate pageViewAddClick:self WithIndex:selectedIndex];
    }
}
